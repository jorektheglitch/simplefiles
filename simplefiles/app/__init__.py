        ...
        if part.name == 'file':
            async with MaterialTempFile.open() as tmp:
                ...
                match mime_type:
                    ...
                    case MIMEType.AUDIO: media = Audio(file_name, mime_subtype, utcnow(), None, file_hash)
                    case MIMEType.CHEMICAL: ...
                    case MIMEType.FONT: ...
                    case MIMEType.IMAGE: media = Image(file_name, mime_subtype, utcnow(), None, file_hash)
                    case MIMEType.VIDEO: ...
                try:
                    session.add(media)
                finally:
